    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900">
                Specialized Unexplained Infertility Solutions
              </span>
            </motion.div>
            ...
            >
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-green-600">Infertility &</span>
                <br />
            ...
            >
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-2xl">
                "If You're Struggling with Unexplained Infertility—Feeling Lost, Unheard, and Wondering If There's Still Hope..."
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
                "Dr. Salma Listens to Every Part of Your Journey and Offers Compassionate, Root-Cause Solutions When Medical Answers Run Out."
              </p>
            </motion.div>
            ...
            >
              <p className="text-xl text-green-600 font-semibold leading-relaxed">
                "Find Clarity, Restore Hope, and Move Forward on Your Path to Parenthood."
              </p>
            </motion.div>
          ...
          >
            <Image
              src="/images/pic55.png"
              alt="Dr. Salma - Unexplained Infertility Solutions Specialist"
              width={500}
              height={600}
...
export default UnexplainedInfertilityHero 