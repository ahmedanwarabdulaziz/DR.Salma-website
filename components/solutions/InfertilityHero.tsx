          ...
          >
            ...
            >
              <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-primary-green">Infertility &</span>
                <br />
            ...
            >
              <p className="text-xl md:text-2xl text-text-gray leading-relaxed max-w-2xl">
                "If You're Struggling With Infertility—Each Month Bringing Disappointment, Unanswered Questions, and a Heart Full of Hope..."
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg md:text-xl text-primary-pink font-semibold leading-relaxed max-w-2xl">
                "Dr. Salma Offers Compassionate, Medical-Naturopathic Expertise to Uncover Hidden Causes and Gently Support Your Path to Parenthood"
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg md:text-xl text-primary-green font-semibold leading-relaxed max-w-2xl">
                "Find Hope, Find Answers, and Move Forward with Confidence"
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-text-gray font-medium">Emotional Support & Compassion</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-primary-green rounded-full"></div>
                <span className="text-text-gray font-medium">Comprehensive Fertility Care</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-primary-pink rounded-full"></div>
                ...
                <div className="relative bg-gradient-to-br from-white via-rose-50/20 to-pink-50/30 rounded-[2rem] shadow-[0_25px_50px_-12px_rgba(168,85,247,0.15)] overflow-hidden border border-rose-200/30">
                  ...
                  <div className="relative p-3">
                    <Image
                      ...
                      alt="Dr. Salma - Fertility Specialist"
                      width={500}
                      height={600}
