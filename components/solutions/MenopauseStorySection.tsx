...
const MenopauseStorySection = () => {
  const commonPhrases = [
    "It's just menopause—everyone goes through it",
    "Have you tried sleeping pills?",
    "Get some exercise and deal with stress",
    "Hormone therapy is your only option"
  ]

  const invisibleStruggles = [
    "The silent exhaustion and forgetfulness that make you doubt yourself",
    "Mood swings or anxiety that seem to come out of nowhere",
    "Joint pain, headaches, or sudden weight gain",
    "Night sweats and restless sleep that leave you tired all day",
    "The frustration when your concerns are minimized or dismissed",
    "The loneliness of not recognizing yourself"
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-green-600 mb-4">
            You're Not Alone—This Change Is Real, and So Are Your Feelings
          </h2>
          ...
          >
            ...
            >
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Once, you felt at home in your body. Now, you wonder who you've become. Some days, it's sweating through your sheets at 2am. Others, it's a wave of sadness, anxiety, or overwhelm that descends for no clear reason. You're snapping at your partner, struggling at work, and feeling invisible at the doctor's office.
              </p>
            ...
            >
              <p className="text-lg text-gray-700 leading-relaxed font-medium">
                Inside, you feel lost in a sea of mixed advice, changing symptoms, and worry about what future years might bring.
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-gray-800 font-semibold leading-relaxed">
                Your struggles are real. They deserve validation and real solutions—not just platitudes.
              </p>
            </motion.div>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            <div className="space-y-4 md:space-y-6">
              <h3 className="text-2xl md:text-3xl font-bold text-green-600">
                Dr. Salma Walks with You—Every Step of the Way
              </h3>
              <h4 className="text-xl md:text-2xl font-semibold text-gray-800">
                A Practitioner Who Truly Listens
              </h4>
              <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                After 20+ years caring for women as a gynecologist, Dr. Salma knows menopause is not "one-size-fits-all." She's met women who left appointments in tears, feeling ignored or pressured into "solutions" they didn't want. That's why she became a medical naturopath: so women could receive both expert guidance and soul-deep compassion during this profound life transition.
              </p>
              <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                She brings you time to share your whole story—not just symptoms on a checklist.
              </p>
            </div>
            ...
            <div className="relative h-full min-h-[300px] md:min-h-[400px] lg:min-h-[500px] mt-6 lg:mt-0">
              <Image
                ...
                alt="Dr. Salma understanding women's menopause journey"
                width={600}
                height={600}
...
export default MenopauseStorySection 