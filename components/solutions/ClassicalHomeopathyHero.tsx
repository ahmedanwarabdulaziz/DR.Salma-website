          ...
          >
            ...
            >
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-green-600">Classical</span>
                <br />
            ...
            >
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-2xl">
                "If You're Struggling with Unresolved Health Issues—You've Tried Everything, and Still Feel Like Something's Missing…"
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
                "Dr. Salma Offers Deeply Personalized, Gentle Healing Through Classical Homeopathy—Honoring Every Symptom, Emotion, and Story that Makes You Unique."
              </p>
            </motion.div>
            ...
            >
              <p className="text-xl text-green-600 font-semibold leading-relaxed">
                "Experience Healing for Your Whole Self—Not Just Your Symptoms."
              </p>
            </motion.div>
            ...
            >
              ...
              <button className="bg-white text-pink-600 border-2 border-pink-600 px-8 py-4 rounded-full font-semibold hover:bg-pink-50 transition-colors duration-300 flex items-center space-x-2">
                <span>Download: "Whole-Person Wellness Guide"</span>
...
export default ClassicalHomeopathyHero 