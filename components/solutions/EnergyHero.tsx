          ...
          >
            ...
            >
              <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-primary-green">Energy &</span>
                <br />
            ...
            >
              <p className="text-xl md:text-2xl text-text-gray leading-relaxed max-w-2xl">
                "If You're Struggling With Never-Ending Fatigue, Anxiety That Won't Let Go, or Pain That Robs You of Joy..."
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg md:text-xl text-primary-pink font-semibold leading-relaxed max-w-2xl">
                "Dr. Salma Understands How Complex These Feelings Can Be—and Offers Gentle, Holistic Solutions to Help You Rediscover Your Energy and Peace."
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg md:text-xl text-primary-green font-semibold leading-relaxed max-w-2xl">
                "Wake Up Feeling Refreshed, Calm, and Ready to Embrace Life Again."
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="text-text-gray font-medium">Root-Cause Analysis</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-primary-pink rounded-full"></div>
                <span className="text-text-gray font-medium">Holistic Wellness Support</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-primary-green rounded-full"></div>
                <span className="text-text-gray font-medium">Natural & Medical Integration</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-primary-pink rounded-full"></div>
                <span className="text-text-gray font-medium">Comprehensive Energy Care</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <button className="btn-secondary group">
                <span className="flex items-center">
                  Download: "Energy Renewal Starter Guide"
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gradient-to-br from-white via-rose-50/20 to-pink-50/30 rounded-[2rem] shadow-[0_25px_50px_-12px_rgba(168,85,247,0.15)] overflow-hidden border border-rose-200/30">
                  ...
                  <div className="relative p-3">
                    <Image
                      src="/images/pic46.png"
                      alt="Dr. Salma - Energy & Wellness Specialist"
                      width={500}
                      height={600}
