        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          ...
          >
            ...
            >
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-green-600">Hormonal</span>
                <br />
            ...
            >
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-2xl">
                If You're Struggling With Adult Acne - Your Skin Feels Like a Battlefield, Your Confidence is Crushed, and You're Tired of Being Told 'Just Wash Your Face'...
              </p>
            </motion.div>
            ...
            >
              <p className="text-xl text-green-600 font-semibold leading-relaxed">
                Finally Feel Beautiful, Confident, and in Control of Your Skin Again
              </p>
            </motion.div>
          ...
          >
            <Image
              ...
              alt="Dr. Salma - Hormonal Acne Treatment Specialist"
              width={500}
              height={600}
...
export default HormonalAcneHero 