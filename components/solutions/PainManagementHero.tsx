          ...
          >
            ...
            >
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-green-600">Pain Management</span>
                <br />
            ...
            >
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-2xl">
                "If You're Struggling with Ongoing Pain—Nothing Seems to Help, You're Tired of Medication, and You Just Want Your Life Back…"
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
                "Dr. Salma Understands How Pain Can Steal Your Joy—and Offers Gentle, Time-Tested Relief with Acupuncture and Holistic Healing."
              </p>
            </motion.div>
            ...
            >
              <p className="text-xl text-green-600 font-semibold leading-relaxed">
                "Experience True, Lasting Relief—Return to the Activities and Happiness You Miss."
              </p>
            </motion.div>
            ...
            >
              ...
              <button className="bg-white text-pink-600 border-2 border-pink-600 px-8 py-4 rounded-full font-semibold hover:bg-pink-50 transition-colors duration-300 flex items-center space-x-2">
                <span>Download: "Gentle Relief Guide for Chronic Pain"</span>
...
export default PainManagementHero 