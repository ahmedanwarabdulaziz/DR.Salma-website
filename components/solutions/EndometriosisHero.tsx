          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900">
                Specialized Endometriosis Pain Management
              </span>
            </motion.div>
            ...
            >
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-green-600">Endometriosis</span>
                <br />
            ...
            >
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-2xl">
                "If You're Struggling with Endometriosis—Living Each Month Around Your Pain, Exhaustion, and the Fear of Not Being Heard..."
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg text-gray-600 leading-relaxed max-w-2xl">
                "Dr. Salma Understands the Silent Battle of Endometriosis and Offers Compassionate, Root-Cause Healing When Conventional Options Fall Short."
              </p>
            </motion.div>
            ...
            >
              <p className="text-xl text-green-600 font-semibold leading-relaxed">
                "Break Free from the Cycle of Pain and Live Life on Your Terms, Not Your Calendar."
              </p>
            </motion.div>
...
export default EndometriosisHero 