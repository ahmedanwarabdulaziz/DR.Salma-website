...
export const metadata: Metadata = {
  ...
  description: 'Discover expert insights on women\'s health, hormonal balance, and natural medicine from Dr. Salma.',
  keywords: 'women\'s health, hormonal balance, natural medicine, blog, Dr. Salma',
  openGraph: {
