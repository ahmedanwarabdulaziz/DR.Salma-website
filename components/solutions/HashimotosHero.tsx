          ...
          >
            ...
            >
              <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-primary-green">Hashimoto's</span>
                <br />
            ...
            >
              <p className="text-xl md:text-2xl text-text-gray leading-relaxed max-w-2xl">
                If You're Struggling With Hashimoto's - You're Exhausted Despite Thyroid Medication, Gaining Weight Constantly, and Your Doctor Says Your Labs Are 'Fine'...
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg text-text-gray leading-relaxed max-w-2xl">
                Dr. Salma Understands the Complexity of Autoimmune Thyroid Conditions and Provides the Comprehensive Support Your Body Actually Needs
              </p>
            </motion.div>
            ...
            >
              <p className="text-xl text-primary-green font-semibold leading-relaxed">
                End the Exhaustion and Brain Fog - Feel in Control of Your Body Again
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="text-text-gray font-medium">Comprehensive Autoimmune Care</span>
              </div>
              <div className="flex items-center space-x-3">
                               <div className="w-3 h-3 bg-primary-pink rounded-full"></div>
               <span className="text-text-gray font-medium">Medical Expertise</span>
             </div>
             <div className="flex items-center space-x-3">
               <div className="w-3 h-3 bg-primary-green rounded-full"></div>
               <span className="text-text-gray font-medium">Natural Healing Protocols</span>
             </div>
             <div className="flex items-center space-x-3">
               <div className="w-3 h-3 bg-primary-pink rounded-full"></div>
               <span className="text-text-gray font-medium">Ongoing Support</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <button className="btn-secondary group">
                <span className="flex items-center">
                  Download Hashimoto's Hope Guide
                 ...
                 <div className="relative bg-gradient-to-br from-white via-green-50/20 to-emerald-50/30 rounded-[2rem] shadow-[0_25px_50px_-12px_rgba(18,102,16,0.15)] overflow-hidden border border-green-200/30">
                  ...
                  <div className="relative p-3">
                    <Image
                      ...
                      alt="Dr. Salma - Hashimoto's Management Specialist"
                      width={500}
                      height={600}
                      className="object-cover w-full h-auto rounded-[1.8rem] shadow-lg"
                    />
                    
                    <div className="absolute inset-3 bg-gradient-to-t from-blue-900/10 via-transparent to-transparent rounded-[1.8rem]"></div>
                  </div>
                   ...
                   <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-md rounded-2xl px-5 py-4 shadow-lg border border-green-200/50">
                     <div className="flex items-center space-x-3">
                       ...
                       <span className="text-sm font-semibold text-gray-700 tracking-wide">Thyroid Expert</span>
                     </div>
                   </div>
