      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            No pressure—just supportive, transformative care at your pace.
          </p>
        </motion.div>
        ...
        >
          <div className="text-center space-y-6 mb-8">
            ...
            <p className="text-gray-600">
              Share your story or your questions, and our care team will respond with the compassion and understanding you deserve.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>• "I'm interested in: Classical Homeopathy"</li>
                  <li>• Your Message (How can we support you, or what would you like us to know?)</li>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200/30">
                ...
                <p className="text-lg font-semibold text-gray-900 italic">
                  "You are not your diagnosis. You are whole, resilient, and worthy of deep healing. Let's start your journey—gently, together."
                </p>
              </div>
            </div>
...
export default ClassicalHomeopathyContactSection 