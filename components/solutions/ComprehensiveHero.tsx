  ...
  return (
    <section ref={containerRef} className="relative min-h-screen overflow-hidden">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-text-dark">
                Medical Expertise Combined with Natural Solutions
              </span>
            </motion.div>
            ...
            >
              <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
                <span className="text-primary-green">Comprehensive</span>
                <br />
            ...
            >
              <p className="text-xl md:text-2xl text-text-gray leading-relaxed max-w-2xl">
                "If You're Struggling With Feeling 'Off' But Not Knowing Why, or Wanting Personalized Care That Treats You as a Whole Person..."
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg md:text-xl text-primary-pink font-semibold leading-relaxed max-w-2xl">
                "Dr. Salma Offers Individualized Assessments and Gentle, Integrative Plans That Honor Your Unique Health Journey."
              </p>
            </motion.div>
            ...
            >
              <p className="text-lg md:text-xl text-primary-green font-semibold leading-relaxed max-w-2xl">
                "Experience Healthcare That's as Unique as You Are."
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="text-text-gray font-medium">Individualized Assessments</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-primary-pink rounded-full"></div>
                <span className="text-text-gray font-medium">Gentle, Integrative Plans</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-primary-green rounded-full"></div>
                <span className="text-text-gray font-medium">Holistic Care Approach</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-primary-pink rounded-full"></div>
                <span className="text-text-gray font-medium">Unique Health Journey Support</span>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                <span className="flex items-center">
                  Download: "Hormonal Harmony Starter Guide"
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gradient-to-br from-white via-rose-50/20 to-pink-50/30 rounded-[2rem] shadow-[0_25px_50px_-12px_rgba(168,85,247,0.15)] overflow-hidden border border-rose-200/30">
                  ...
                  <div className="relative p-3">
                    <Image
                      src="/images/pic51.png"
                      alt="Dr. Salma - Comprehensive Women's Care Specialist"
                      width={500}
                      height={600}
      ...
      <DownloadPopup
        ...
        guideName="Hormonal Harmony Starter Guide"
      />
    </section>
  )
}
