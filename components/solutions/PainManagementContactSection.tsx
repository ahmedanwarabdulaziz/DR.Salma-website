...
const PainManagementContactSection = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Your healing isn't another prescription, but a partnership—with gentle wisdom, expert care, and hope.
          </p>
        </motion.div>
        ...
        >
          <div className="text-center space-y-6 mb-8">
            ...
            <p className="text-gray-600">
              Share your story or questions, and our specialist team will respond with compassion and clarity.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>• "I'm interested in: Pain Management (TCM/Acupuncture)"</li>
                  <li>• Your Message (Tell us your struggle or how we can help)</li>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200/30">
                ...
                <p className="text-lg font-semibold text-gray-900 italic">
                  "You are not your suffering. You are strong—and you deserve comfort, relief, and a life you love. Let's start this healing journey—gently, with trust, together."
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl p-6 border border-pink-200/30">
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full bg-white text-pink-600 border-2 border-pink-600 px-6 py-3 rounded-full font-semibold hover:bg-pink-50 transition-colors duration-300 text-sm">
                    Download: "Gentle Relief Guide for Chronic Pain"
                  </button>
                  <button className="w-full bg-white text-pink-600 border-2 border-pink-600 px-6 py-3 rounded-full font-semibold hover:bg-pink-50 transition-colors duration-300 text-sm">
...
export default PainManagementContactSection 